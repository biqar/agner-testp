rem              y32.bat                     2011-06-04 Agner Fog

rem  Makes PMCTest program for 32 bit Windows from assembly using yasm assembler
...
yasm -f win32 --prefix=_ -l b32.lst -o b32.obj -DWINDOWS=1 PMCTestB32.nasm
