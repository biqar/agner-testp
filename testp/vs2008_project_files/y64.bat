rem              y64.bat                     2011-06-04 Agner Fog

rem  Makes PMCTest program for 64 bit Windows from assembly using yasm assembler
...
yasm -f win64 -l b64.lst -o b64.obj -DWINDOWS=1 PMCTestB64.nasm
